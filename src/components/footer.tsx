...
export interface FooterProps {
  ...
  copyright?: string
  brandName?: string
  contactStrip?: { icon: string; text: string }[]
}
...
const socialIcons: Record<string, string> = {
  ...
  tiktok: "M9 12a4 4 0 1 0 4 4V2h4a6 6 0 0 0 6 6v4a8 8 0 0 1-8-8v4a8 8 0 0 1-8 8Z",
}
    ...
    <footer className="bg-secondary py-12 text-secondary-foreground relative">
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
          <div>
            <div className="text-xl font-extrabold text-accent mb-3">{brandName}</div>
        ...
        <div className="mt-8 text-center text-xs text-white/40">
          {copyright || `© ${new Date().getFullYear()} ${brandName || "Tienda"}. Todos los derechos reservados.`}
        </div>
      </div>
    </footer>
  )
